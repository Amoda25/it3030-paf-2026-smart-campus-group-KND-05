  ...
  <div style={{ padding: '150px 0', textAlign: 'center', minHeight: '100vh', background: 'var(--bg-deep)' }}>
    <div className="container">
        <div className="glass" style={{ padding: '4rem', borderRadius: '32px', maxWidth: '600px', margin: '0 auto' }}>
            <ShieldCheck size={64} className="text-primary mb-6" style={{ margin: '0 auto 1.5rem auto' }} />
            <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>System & Admin</h1>
            <p style={{ color: 'var(--text-muted)', marginBottom: '2rem' }}>This module is currently under development (Member 4).</p>
